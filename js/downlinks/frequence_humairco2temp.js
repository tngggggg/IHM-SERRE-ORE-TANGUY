...
const devEui = "010101010101010101";    // Mettre DevEUI STM32
...
if (isNaN(frequence)) {
  console.error("Valeur fréquence non valide.");
  process.exit(1);
}
...
deviceService.enqueue(req, metadata, (err, resp) => {
  ...
  console.log("Fréquence (humidité/co2/temp) envoyée. ID:", resp.getId());
});